...
import com.atid.app.myRfid.util.SoundPlay;
import com.atid.app.myRfid.view.SelectionMask6cActivity;
...
public abstract class ActionActivity extends ReaderActivity implements
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		...
		if ((keyCode == KeyEvent.KEYCODE_SOFT_RIGHT
			...
			Log.i(TAG,
					String.format("INFO. onKeyDown(%d, %d)", keyCode,
							event.getAction()));
	...
	public boolean onKeyUp(int keyCode, KeyEvent event) {
		...
		if ((keyCode == KeyEvent.KEYCODE_SOFT_RIGHT
			...
			Log.i(TAG,
					String.format("INFO. onKeyUp(%d, %d)", keyCode,
							event.getAction()));
	...
	public void onItemSelected(AdapterView<?> parent, View view, int position,
		...
		case R.id.power_gain:
			try {
				...
				Log.e(TAG, String.format("ERROR. onItemSelected(%d)", position));
			}
			break;
		case R.id.tag_type:
			break;
	...
	protected void initWidgets() {
		...
		adpTagType = new SpinnerAdapter(this,
